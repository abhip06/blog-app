            ...
            <div className="flex md:flex-row flex-col justify-between items-start gap-7 w-full">
                ...
                <div className="flex flex-col justify-start sm:gap-6 gap-4 text-gray-500">
                    ...
                    <ul className="flex sm:gap-7 gap-5">
                        <li className="sm:text-xl text-lg cursor-pointer hover:scale-105 hover:text-white"><a href="https://www.linkedin.com/in/abhinav-patel-38480b254/">{<FaLinkedin />}</a></li>
                        <li className="sm:text-xl text-lg cursor-pointer hover:scale-105 hover:text-white"><a href="https://www.x.com/abhip006">{<BsTwitterX />}</a></li>
                        <li className="sm:text-xl text-lg cursor-pointer hover:scale-105 hover:text-white"><a href="https://www.github.com/abhip06">{<FaGithub />}</a></li>
                        <li className="sm:text-xl text-lg cursor-pointer hover:scale-105 hover:text-white"><a href="https://www.instagram.com/">{<FaInstagram />}</a></li>
                    </ul>
                </div>
